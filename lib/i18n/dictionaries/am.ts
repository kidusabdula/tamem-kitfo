...
export const am: Dictionary = {
  ...
  requests: {
    title: 'የእርስዎ ጥያቄዎች',
    eyebrow: 'ሁኔታውን ይመልከቱ',
    intro: 'ከዚህ መሣሪያ የላኩልን ትዕዛዞች፣ የኬተሪንግ ጥያቄዎችና የጠረጴዛ ማስያዣዎች።',
    none: 'ከዚህ መሣሪያ የተላከ ገና የለም',
    noneHint: 'የሚልኩልን ነገር ሁሉ በኋላ እንዲከታተሉት እዚህ ይታያል።',
    lookupTitle: 'በኮድ ያግኙት',
    lookupHint: 'በሌላ ስልክ አዘዙ? የሰጠንዎትን ኮድና የተጠቀሙበትን ስልክ ቁጥር ያስገቡ።',
    codeLabel: 'ኮድ',
    phoneLabel: 'ስልክ ቁጥር',
    check: 'ሁኔታውን ይመልከቱ',
    notFound: 'ልናገኘው አልቻልንም። ኮዱንና የስልክ ቁጥሩን አረጋግጠው እንደገና ይሞክሩ።',
    forget: 'ከዚህ መሣሪያ ያስወግዱ',
    placed: 'የተላከበት',
    track: 'ሁኔታውን ይመልከቱ',
    kinds: {
      order: 'ትዕዛዝ',
  ...
  catering: {
    ...
    process: {
      eyebrow: 'እንዴት እንደሚሠራ',
      title: 'ከመጀመሪያው ጥሪ እስከ መጨረሻው ቡና',
      body: 'አራት ደረጃዎች ናቸው፤ በመካከል ያለውን ሁሉ እኛ እንሸከማለን።',
      steps: {
        ask: {
          title: 'ቀኑን ይንገሩን',
          body: 'ቀኑን፣ በግምት የእንግዶቹን ብዛትና ቦታውን። በስልክ መደወል ብዙውን ጊዜ ከቅጹ ይፈጥናል፤ ሁለቱም ወደ አንድ ሰው ነው የሚደርሱት።',
        },
        menu: {
          title: 'ምናሌውን አብረን እናዘጋጃለን',
          body: 'ስለ ምግቦቹ፣ ስለ መጠናቸውና እንግዶችዎ ስለሚያስፈልጋቸው የጾም አማራጮች እንነጋገራለን። እርስዎ እስኪስማሙ ድረስ ምንም አይጸናም።',
        },
        setup: {
          title: 'መጥተን እናዘጋጃለን',
          body: 'ሼፎች፣ የሸክላ ማብሰያ፣ መሶብና የቡና ማዘጋጃው ከእኛ ጋር ይጓዛሉ። የመጀመሪያው እንግዳ ከመግባቱ በፊት ተዘጋጅተን እንጠብቃለን።',
        },
        serve: {
          title: 'እናቀርባለን፤ ከዚያም እናጸዳለን',
          body: 'ክትፎው በእንግዶችዎ ፊት ይዘጋጃል፤ ቡናውም እስከ ሦስተኛው ዙር ይቀጥላል። በኋላም ኩሽናው ወደ መኪናው ተመልሶ ቦታዎ እንዳገኘነው ይሆናል።',
        },
      },
    },
    occasions: {
      eyebrow: 'ምን እናዘጋጃለን',
      title: 'በደንብ የምናውቃቸው ዝግጅቶች',
      body: 'እያንዳንዱ ዝግጅት የራሱ ቅኝት አለው። እነዚህ ይህ ኩሽና ረጅም ዘመን ያበሰለላቸው ናቸው።',
      items: {
        wedding: {
          title: 'ሠርግ',
          body: 'ረጅሙ ጠረጴዛ፣ አገልግሉ፣ እና ማንም የማይቆጥረው ክትፎ። ከአዳራሽዎ ጋር በጋራ እንሠራለን፤ ንግግሮቹ ሲረዝሙም ቡናው አይቋረጥም።',
        },
        mahiber: {
          title: 'ማህበር',
          body: 'ወርሃዊ ማህበር የራሱ ሥርዓት አለው። ከሥርዓቱ ጋር እንጂ በተቃራኒው አናበስልም፤ መቼ ገለል ማለት እንዳለብንም እናውቃለን።',
        },
        corporate: {
          title: 'ቢሮ እና ድርጅት',
          body: 'በሰዓቱ የሚደርስና ሁለተኛ ሰዓት የማይፈልግ ምሳ። ለቡድን ቀን፣ ለምረቃ ወይም በአግባቡ ሊስተናገዱ ለሚገባቸው እንግዶች ተስማሚ ነው።',
        },
        birthday: {
          title: 'የልደት በዓል',
          body: 'ትንንሽ ክፍሎች፣ ቤተሰብና ጎረቤት፣ እና በአንድ ጠረጴዛ ላይ ለሽማግሌዎችም ለልጆችም የሚሆን ምናሌ።',
        },
        memorial: {
          title: 'ተዝካር',
          body: 'ተዝካር ጸጥታን፣ የተትረፈረፈ ምግብንና ከአስተናጋጆች ዝምታን ይሻል። ቀድመን እንደርሳለን፣ በጸጥታ እንሠራለን፣ ሲጠናቀቅም እንሄዳለን።',
        },
      },
    },
